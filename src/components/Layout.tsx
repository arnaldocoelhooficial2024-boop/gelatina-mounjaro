  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-slate-900 text-slate-900 dark:text-white font-sans selection:bg-brand-200 selection:text-brand-900 pb-32 transition-colors duration-300">
      ...
      <div className="fixed bottom-6 left-4 right-4 z-40 pointer-events-none">
        <nav className="bg-white/95 dark:bg-slate-800/95 backdrop-blur-2xl border border-slate-200/50 dark:border-slate-700/50 shadow-[0_20px_40px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.3)] rounded-3xl px-6 py-4 flex justify-between items-center pointer-events-auto max-w-md mx-auto transition-colors duration-300">
